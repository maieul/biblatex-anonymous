...
\begin{release}{2.4.0}{2016-09-22}
  \item Add compatibility with anonymous \bibtype{inreference}, \bibtype{bookinreference} and \bibtype{bookininreference}.
  \item Take account of the \bibfield{maintitle} field for sorting with \verb+anonymous+ sorting scheme.
\end{release}
