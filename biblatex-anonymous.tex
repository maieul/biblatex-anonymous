...
If you want to use the \bibfield{editor} or \bibfield{translator} for a entry concerned by this package (e.g. \bibtyp{book}, \bibtype{bookinbook} etc.), you can use the \verb+useeditor=true+ or \verb+usetranslator=true+ 
