...
\begin{release}{2.4.0}{2016-09-25}
  \item Also for anonymous \bibtype{inreference}, \bibtype{bookinreference} and \bibtype{bookininreference}.
  \item Fix bug add by version 2.2.2 when using the \emph{biblatex-realauthor} package.
\end{release}
